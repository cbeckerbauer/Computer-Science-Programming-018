...
public class Diamond {
	...
	public static void main(String[] args) {
		...
		for(int rows = 0; rows < size; rows++) {
			...
			System.out.print("/");
			for(int spaces = size - rows; spaces < size; spaces++) { // starting small getting larger
				System.out.print("  ");
			}
			System.out.println("\\");
		}
		...
		for(int rows = 0; rows < size; rows++) {
			...
			for(int spaces = 1; spaces < size - rows; spaces++) { // starting large and getting smaller
				System.out.print("");
			}
			System.out.println("/");
