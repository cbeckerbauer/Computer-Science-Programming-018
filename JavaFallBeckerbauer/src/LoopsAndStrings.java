...
public class LoopsAndStrings {
	...
	public static void main(String[] args) {
		 ...
		 * The first character is at the 0 index
		...
		// System.out.println(word.charAt(word.length))); throws an error because it looking at an index that doesn't exist
		...
		System.out.println(wordTwo.substring(0,2)); // prints wo
		System.out.println(wordTwo.substring(0,3)); // prints wor
