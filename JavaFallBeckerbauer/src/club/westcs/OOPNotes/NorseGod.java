...
public class NorseGod {
	...
	/**
	 * If the viking does not exist or has died t will make a new viking
	 */
	public void setMyViking() {
		if(this.myViking == null || this.myViking.isAlive() == false) {
			String [] names = {"Hrothgar", "Beowulf", "Sven", "Erik"};
			this.myViking = new Viking(names[rand.nextInt(names.length)]);
		}
	}
	/**
	 * The current numeric health of a Norse God Object
	 * @return int health
	 */
	 ...
	 * @param myChoice String the choice the god has made, Uf not reconized it autos to nothing
	...
	/**
	 * the method to deal damage to another Norse God Object or the god's viking
	 * @param other the target Norse God object
	 */
	...
	/**
	 * takes away a spceified amount of health
	 * @param i the amount that Norse God loses health
	 */
	...
	/**
	 * asks the user to choose and action
