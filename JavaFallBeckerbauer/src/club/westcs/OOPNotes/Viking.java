...
public class Viking {
	...
	//Attributes
		 ...
		 * 		private
		 * 			-an access modifier that created a variable available only to this class
		 */
		private String name;
	...
	//Constructor
		 ...
		 * Always names and spelled just like the class
		 */
		public Viking() {
			rand = new Random();
	...
	//Methods
		 ...
		 * look like function but belong to objects
		...
		public void loseAWeapon() {
			System.out.println("Garrrrrrrhhhhh!");
