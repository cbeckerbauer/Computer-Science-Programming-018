...
public class MadLibBeckerbauer {
	...
	public static void main(String[] args) {
		...
		System.out.println("Please only use capital letters when a proper noun and the first word, and no spaces. "
				+ "Hit enter to get the next question to answer, and then enjoy the story the computer has created with your words.");
		...
		System.out.println("Santa: I started making that toy in " + year + ". What will little " + celebrityname 
				+ " think when he/she wakes up on Christmas morning with nothing under the " + plant + "?");
		...
		System.out.println("Santa: The reason I work so hard, is because I get to spread joy to millions of people, and go sit by the fire shaking my " + bodypart 
				+ " while eating cookies and drinking " + drink + "." );
		System.out.println("Elf: Fine I stole the toy. But I only did it because I wanted to impress my " + typeofdoctor + ".");
		System.out.println("Santa: " + onesyllablenoise + " " + onesyllablenoise + " " + onesyllablenoise 
				+ ". Every time there's a holiday miracle, I sing my favorite Christmas song, Jingle " + pluralnoun + ".");
